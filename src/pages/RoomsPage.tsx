  ...
  const rooms = [
    {
      ...
      image: 'https://media.istockphoto.com/id/1478366472/pt/foto/cheap-hostel-room-with-wooden-bunk-beds.jpg?s=1024x1024&w=is&k=20&c=n-wppCRyZ-5qENUOeuOaEe9bYAZGHq0gMGyxM02jqWw=',
      rating: 3.8,
      reviews: 200
    },
    {
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl"> {/* Adicionado: max-w-7xl para limitar largura total e evitar shifts em telas largas */}
        ...
        <div className="flex flex-col lg:flex-row gap-8 min-w-0"> {/* Adicionado: min-w-0 para flex não expandir horizontalmente */}
          ...
          <div className="w-full max-w-4xl mx-auto flex flex-col items-center gap-8 min-h-[600px] pb-16">
                          ...
                          <div className="flex justify-between items-start gap-4">
                            <div className="flex flex-wrap gap-2 min-h-[60px] flex-1 min-w-0"> {/* flex-1 min-w-0 para não expandir horizontalmente */}
                              {room.features.map((feature, index) => (
                                <Badge key={index} variant="secondary" className="text-xs whitespace-nowrap"> {/* whitespace-nowrap para badges não quebrarem linha excessivamente */}
                                  {feature}
                                </Badge>
                              ))}
                            </div>
            ...
            {/* CTA Section - Largura fixa e centralizada */}
            <div className="w-full max-w-4xl mx-auto text-center mt-16 p-8 bg-white rounded-lg shadow-sm">
